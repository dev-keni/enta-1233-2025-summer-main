...
namespace StarterAssets
{
...
#if ENABLE_INPUT_SYSTEM
    [RequireComponent(typeof(MeInputs))]
#endif
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Tooltip("Sets values from input system")]
        [SerializeField] private MeInputs _input;

        [Header("Aim Camera")]
        [Tooltip("Camera used in aim state")]
        [SerializeField] private CinemachineVirtualCameraBase AimCamera;

        [Header("Camera Sensitivity")]
        [Tooltip("General camera speed")]
        [SerializeField] private float Sens = 2.0f;
        ...
        private void CameraRotation()
        {
            ...
            if (_input.look.sqrMagnitude >= _threshold && !LockCameraPosition)
            {
                ...
                float sensitivityMultiplier = _input.Aim ? AimSens : Sens;
